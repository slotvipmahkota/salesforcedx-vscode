...
checkVSCodeVersion();
const RELEASE_TYPE = process.env['RELEASE_TYPE'] || getReleaseType();
...
// beta versions should not be merged directly to develop, so we don't merge back or create the changelog
if (!isBetaRelease()) {
